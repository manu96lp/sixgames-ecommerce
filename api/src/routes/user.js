...
server.get( '/:id/orders', isAuthenticated, ( request, response, next ) => {
...
server.post( '/:id/cart', isAuthenticated, ( request, response, next ) => {
	const { id } = request.params;
...
server.get( '/:id/cart', isAuthenticated, ( request, response, next ) => {
	const { id } = request.params;
...
server.delete( '/:id/cart', isAuthenticated, ( request, response, next ) => {
	const { id } = request.params;
...
server.get( '/:id', hasAccessLevel( ), ( request, response, next ) => {
